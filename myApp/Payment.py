...
def paymenthistory(request,id):
   ...
   return render(request,template,{"retval":retval_list,"account":account,"accoutrecord":accountrecord,"context":context,"defval":defval_year,"year_list":year_list,"ReqParams":ReqParams})
